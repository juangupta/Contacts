...
namespace Contacts.Services
{
    ...
    {
        //<T> se reemplaza por una clase valida, para hacer Get a cualquier entidad
        public async Task<Response> Get<T>(string urlBase, string servicePrefix, string controller)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    return new Response
                    {
                        //TODO: Mejorar para generar el mensaje de respuesta del API
                        //No la respuesta de la petición HTTP
                        IsSuccess = false,
